/*
 * haloam3517.h - Header file for the Halo Instrument AM3517
 *
 * Author: Sean Donohue <sean.donohue@asdi.com>
 *
 * Based on board/logicpd/am3517evm.h
 *
 * Copyright (C) 2016
...
#ifndef _HALOAM3517_H_
#define _HALOAM3517_H_
...
#define MUX_HALOAM3517() \
	...
	MUX_VAL(CP(GPMC_NCS6),		(IDIS | PTU | EN  | M4)) /*GPIO_57 - HSUSB1_RST*/\
	...
	MUX_VAL(CP(MMC1_DAT6),		(IDIS | PTU | EN  | M4)) \
	...
	MUX_VAL(CP(MCBSP2_DR),		(IDIS | PTU | EN  | M4)) /*GPIO_118 - FPGA_RESET#*/\
	...
	/* CCDC */\
	MUX_VAL(CP(CCDC_PCLK),		(IDIS | PTU | EN  | M4)) /*GPIO_94 - PMIC_WD_HOLDOFF*/\
	MUX_VAL(CP(CCDC_FIELD),		(IEN  | PTD | DIS | M1)) \
	MUX_VAL(CP(CCDC_HD),		(IEN  | PTU | EN  | M0)) \
	MUX_VAL(CP(CCDC_VD),		(IDIS | PTD | EN  | M4)) /*GPIO_97 - PMIC_KILL*/\
	...
	MUX_VAL(CP(SYS_BOOT0),		(IEN  | PTD | DIS | M4)) /*GPIO_2*/\
							 /* - PEN_IRQ */\
	/*MUX_VAL(CP(SYS_BOOT1),		(IDIS | PTU | EN  | M4)) GPIO_3 - WLAN_EN*/\
	MUX_VAL(CP(SYS_BOOT1),		(IDIS | PTD | DIS | M4)) /*GPIO_3 - WLAN_EN*/\
