/*
 * haloam3517.c - board file for the Halo Instrument AM3517
 *
 * Author: Sean Donohue <sean.donohue@panalytical.com>
 *
 * Based on board/logicpd/am3517evm.c
 *
 * Copyright (C) 2016
 * ASD Incorporated - http://www.asdi.com/
 *
 */
...
int misc_init_r(void)
{
	...
	/* Bring PMIC_SW_HOLDOFF high */
	gpio_direction_output(94, 1);

	/* Bring FPGA_RESET# high */
